...
- Agreement: **18/40 = 45.0%** (≥80% target NOT met — synthetic)
- Class→status mapping: S1→thriving, S2→thriving, S3→struggling, N→failed
- Limiting factor in disagreements: slope (8), altitude (7), precipitation (5), temperature (1), shading (1)
...
| GUL-003 | Gulmi | thriving | S3 | 0.60 | struggling | ✗ (pessimistic) | slope |
...
| GUL-008 | Gulmi | struggling | S3 | 0.65 | struggling | ✓ | precipitation |
...
| SYA-008 | Syangja | failed | S3 | 0.69 | struggling | ✗ (optimistic) | slope |
...
| KAV-011 | Kavre | struggling | S3 | 0.62 | struggling | ✓ | slope |
