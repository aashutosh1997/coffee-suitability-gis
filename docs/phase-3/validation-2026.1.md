...
- Limiting factor in disagreements: slope (10), altitude (8), shading (4)
...
| SYA-004 | Syangja | struggling | S2 | 0.66 | thriving | ✗ (optimistic) | altitude |
...
| SYA-010 | Syangja | failed | S2 | 0.66 | thriving | ✗ (optimistic) | altitude |
